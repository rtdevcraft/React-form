...
>((props, ref) => {
  const { id, name, value, onChange, label, error, rows = 3 } = props
    ...
    <div className='relative mb-6'>
      ...
      <div className='relative'>
        ...
        <textarea
          ...
          rows={rows}
          ref={ref}
          className={`w-full p-4 pt-6 peer border rounded transition-all duration-300 bg-white focus:outline-none focus:ring-2 focus:border-transparent resize-none ${
            error
